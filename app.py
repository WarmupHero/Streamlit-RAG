...
with column_1:
    ...
    if st.session_state["show_disclaimer"]:
        ...
        **Disclaimer**
        ...
        The dataset used within the Software is derived from publicly available data on Kaggle, which contains both real and synthetic (fake) job postings. As such, the content and structure of the data may include inaccuracies, inconsistencies, or fabricated information that does not reflect real-world job listings. The Software does not verify or validate the authenticity of the data.
